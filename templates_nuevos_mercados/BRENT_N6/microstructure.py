"""
BRENT_N6 Brent Crude Oil Robot — Microstructure Features
tick_volume — commodity CFD (ICE London).
Round numbers: $5 and $10 steps.
Prime session: 03:00-13:30 CT (Mon-Fri, London open through NYMEX overlap).
"""
...
def build_intraday_features(df_bars: pd.DataFrame, interval: str = "5m") -> pd.DataFrame:
    ...
    # Brent-specific: distance to $5 and $10 round numbers
