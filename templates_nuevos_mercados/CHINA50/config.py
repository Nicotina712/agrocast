"""
CHINA50 FTSE China A50 Robot (clon plantilla HK50, validado 2026-06-10) — Configuration
...
ARTIFACTS_DIR   = os.path.join(_MVP_ROOT, "artifacts", "china50")
...
SYMBOL           = "CHINA50"
FALLBACK_SYMBOLS = ["CHINA50", "CN50", "ChinaA50", "CHINA50.cash"]
...
PRIME_OPEN_CT    = time(20, 0)   # 20:00 CT = 09:00 CST — apertura sesion dia China A50
PRIME_CLOSE_CT   = time(14, 0)   # 14:00 CT — edge VWAP positivo en TODAS las franjas (PF 1.67-1.99), ventana ancha
...
# ── Cierre pre-finde en positivo (06-29): índice gapea el lunes y el gap atraviesa el SL.
# Backtest 9m: cerrar GANADORES el viernes antes del cierre semanal -> PF de trades de finde
# 1.90→4.57, retorno total neutro (−0.015 expR). NO cerrar perdedores (flat-siempre cuesta retorno).
WEEKEND_PROFIT_CLOSE = True
WEEKEND_FLAT_CT      = time(17, 30)   # viernes >=17:30 CT (mercado cierra ~18:30 CT); solo si P&L>0
RSI_LONG_LO  = 38
RSI_LONG_HI  = 65
RSI_SHORT_LO = 35
RSI_SHORT_HI = 62
...
MIN_SL_PCT           = 0.3
MAX_LLM_CALLS_PER_DAY = 30   # subido 16->30 (ventana 18h; 16 topaba a media sesion)   # raised: was hitting limit exactly (10/10)
