"""ETHUSD — Web Dashboard (port 8082)"""
...
<title>{EMOJI} ETHUSD Dashboard</title>
<style>
...
def start_dashboard(port=PORT):
    ...
    print(f"ETHUSD dashboard: http://localhost:{port}")
    srv.serve_forever()
