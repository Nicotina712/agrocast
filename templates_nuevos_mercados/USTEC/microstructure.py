"""
USTEC Nasdaq 100 Robot — Microstructure Features
tick_volume (not volume) — equity index CFD.
Round numbers: 500pt and 1000pt steps.
Prime session: 08:30-15:00 CT (Mon-Fri).
"""
...
def build_intraday_features(df_bars: pd.DataFrame, interval: str = "5m") -> pd.DataFrame:
    ...
    # USTEC-specific: distance to round numbers (500pt and 1000pt steps)
    ...
    feats["dist_round5k"]   = feats["dist_round500"]  # compatibility alias
