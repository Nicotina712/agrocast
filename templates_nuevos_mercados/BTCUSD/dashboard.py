"""BTCUSD — Web Dashboard (port 8081)"""
...
EMOJI  = "🟠"
NAME   = "Bitcoin / BTCUSD"
REG_FIELD = "btc_regime"
CTX_FIELD = "risk_on_off"
...
<title>{EMOJI} BTCUSD Dashboard</title>
<style>
...
def start_dashboard(port=PORT):
    ...
    print(f"BTCUSD dashboard: http://localhost:{port}")
    srv.serve_forever()
