"""
UK100 FTSE 100 Robot — Microstructure Features
tick_volume — equity index CFD (London).
Round numbers: 100pt and 500pt steps.
Prime session: 02:00-11:30 CT (Mon-Fri, London hours).
"""
...
def build_intraday_features(df_bars: pd.DataFrame, interval: str = "5m") -> pd.DataFrame:
    ...
    # UK100-specific: distance to 100pt and 500pt round numbers
